 ...
 * {@link RenderAnimatedModel} or a //TODO: RenderMHFCModelTile<br>
 * This is a pretty simple type of entity that doesn't have much setup to do,
 * apart from setting an animation.
 *
 * @author WorldSEnder
 *
 */
public interface IAnimatedObject {
	public static final IAnimator animator = new IAnimator() {
		@Override
		public IRenderPassInformation preRenderCallback(Entity entity,
				RenderPassInformation buffer, float partialTick,
				float uLimbSwing, float interpolatedSwing, float uRotfloat,
				float headYaw, float interpolatedPitch) {
			return ((IAnimatedObject) entity).preRenderCallback(
					interpolatedPitch, buffer);
		}
	};
	/**
